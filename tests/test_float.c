...
static void check3(const char *name, const char *op, const uint16_t *exp, const uint16_t *got)
{
    fptest_total++;
    if (memcmp(exp, got, 3 * sizeof(uint16_t)) != 0)
    {
        printf("  FAIL  %-34s %s: expected %06o %06o %06o, got %06o %06o %06o\n", name, op, exp[0],
               exp[1], exp[2], got[0], got[1], got[2]);
        fptest_failed++;
    }
}
...
static const fp48_pair_case fp48_pairs[] = {
    ...
    {{0040001, 0100000, 0000000},
     ...
     0},
    /* +3, +1 */
    {{0040002, 0140000, 0000000},
     {0040001, 0100000, 0000000},
     {0040003, 0100000, 0000000},
     {0040002, 0100000, 0000000},
     {0040002, 0140000, 0000000},
     {0040002, 0140000, 0000000},
     0},
    /* +2, +1.5 */
    {{0040002, 0100000, 0000000},
     {0040001, 0140000, 0000000},
     {0040002, 0160000, 0000000},
     {0040000, 0100000, 0000000},
     {0040002, 0140000, 0000000},
     {0040001, 0125252, 0125253},
     0},
    /* +2, +1.9375 */
    {{0040002, 0100000, 0000000},
     {0040001, 0174000, 0000000},
     {0040002, 0176000, 0000000},
     {0037775, 0100000, 0000000},
     {0040002, 0174000, 0000000},
     {0040001, 0102041, 0004103},
     0},
    /* +1.5, +1.5 */
    {{0040001, 0140000, 0000000},
     {0040001, 0140000, 0000000},
     {0040002, 0140000, 0000000},
     {0000000, 0000000, 0000000},
     {0040002, 0110000, 0000000},
     {0040001, 0100000, 0000000},
     0},
    /* +2, +3 */
    {{0040002, 0100000, 0000000},
     {0040002, 0140000, 0000000},
     {0040003, 0120000, 0000000},
     {0140001, 0100000, 0000000},
     {0040003, 0140000, 0000000},
     {0040000, 0125252, 0125253},
     0},
    /* +6, +2 */
    {{0040003, 0140000, 0000000},
     {0040002, 0100000, 0000000},
     {0040004, 0100000, 0000000},
     {0040003, 0100000, 0000000},
     {0040004, 0140000, 0000000},
     {0040002, 0140000, 0000000},
     0},
    /* -9, -3 */
    {{0140004, 0110000, 0000000},
     {0140002, 0140000, 0000000},
     {0140004, 0140000, 0000000},
     {0140003, 0140000, 0000000},
     {0040005, 0154000, 0000000},
     {0040002, 0140000, 0000000},
     0},
    /* +0.5, +0.5 */
    {{0040000, 0100000, 0000000},
     ...
     {0040001, 0100000, 0000000},
     {0000000, 0000000, 0000000},
     {0037777, 0100000, 0000000},
     {0040001, 0100000, 0000000},
     0},
    /* pi-ish, e-ish (full 32-bit mantissas) */
    {{0040002, 0144417, 0157534},
     {0040002, 0125676, 0130621},
     {0040003, 0135147, 0044166},
     {0037777, 0165211, 0067130},
     {0040004, 0103343, 0057560},
     {0040001, 0112731, 0105646},
     0},
    /* big exponent vs small exponent (scale > 31 path) */
    {{0042000, 0123456, 0165432},
     {0036000, 0134567, 0012345},
     {0042000, 0123456, 0165432},
     {0042000, 0123456, 0165432},
     {0037777, 0171075, 0054264},
     {0044000, 0163303, 0164301},
     0},
    ...
    {{0000000, 0000000, 0000000},
     ...
     1},
    /* -1.5, +255 */
    {{0140001, 0140000, 0000000},
     {0040010, 0177400, 0000000},
     {0040010, 0176600, 0000000},
     {0140011, 0100100, 0000000},
     {0140011, 0137500, 0000000},
     {0137771, 0140300, 0140301},
     0},
    /* tiny difference (deep cancellation in add path) */
    {{0040001, 0100000, 0000001},
     {0140001, 0100000, 0000000},
     {0037742, 0100000, 0000000},
     {0040002, 0100000, 0000000},
     {0140001, 0100000, 0000001},
     {0140001, 0100000, 0000001},
     0},
};
