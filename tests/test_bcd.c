...
static void bcdtest_fail(const bcd_test_case *tc, const char *what,
...
static void bcdtest_run(const bcd_test_case *tc)
{
    ...
    switch (tc->op)
    {
        case OP_ADDD:  ndfunc_addd(0140120);   break;
        case OP_SUBD:  ndfunc_subd(0140121);   break;
        case OP_COMD:  ndfunc_comd(0140122);   break;
        case OP_PACK:  ndfunc_pack(0140124);   break;
        case OP_UPACK: ndfunc_unpack(0140125); break;
        case OP_SHDE:  ndfunc_shde(0140126);   break;
    }
...
static const bcd_test_case bcdtest_cases[] =
{
    ...
    /* ---------------------------------------------------------------- */
    {
        ...
        OP_ADDD, 0x0008, 0x0008,
        { 0x9999, 0x998C }, 2,
        { 0x0000, 0x001C }, 2,
        DEST_OP1, { 0x9999, 0x999C }, 2, true, -1
    },
    {
        "TPE ADDD  EMPTY + EMPTY = 0 (TFIRE: SKIP)",
        OP_ADDD, 0x0000, 0x0000,
        { 0 }, 0,
        { 0 }, 0,
        DEST_NONE, { 0 }, 0, true, -1
    },
    {
        "TPE ADDD  L4 097+ + L2 lr unsigned 3 = 100+",
        OP_ADDD, 0x0004, 0xA002,
        { 0x097C }, 1,
        { 0x003F }, 1,
        DEST_OP1, { 0x100C }, 1, true, -1
    },
    {
        "TPE ADDD  L4 097+ + EMPTY = 097+",
        OP_ADDD, 0x0004, 0x0000,
        { 0x097C }, 1,
        { 0 }, 0,
        DEST_OP1, { 0x097C }, 1, true, -1
    },
    {
        "TPE ADDD  EMPTY + L4 097+ = overflow (ERROR)",
        OP_ADDD, 0x0000, 0x0004,
        { 0 }, 0,
        { 0x097C }, 1,
        DEST_NONE, { 0 }, 0, false, -1
    },
    ...
    },
    {
        ...
        OP_SUBD, 0x0004, 0xA002,
        { 0x097C }, 1,
        { 0x003F }, 1,
        DEST_OP1, { 0x094C }, 1, true, -1
    },
    {
        "TPE SUBD  L4 097+ - EMPTY = 097+",
        OP_SUBD, 0x0004, 0x0000,
        { 0x097C }, 1,
        { 0 }, 0,
        DEST_OP1, { 0x097C }, 1, true, -1
    },
    ...
    {
        "ADDD  +12 + +5 = +17",
        OP_ADDD, 0x0004, 0x0004,
        { 0x012C }, 1, { 0x005C }, 1,
        DEST_OP1, { 0x017C }, 1, true, -1
    },
    {
        "ADDD  -5 + +12 = +7",
        OP_ADDD, 0x0004, 0x0004,
        { 0x005D }, 1, { 0x012C }, 1,
        DEST_OP1, { 0x007C }, 1, true, -1
    },
    {
        "SUBD  +12 - +5 = +7",
        OP_SUBD, 0x0004, 0x0004,
        { 0x012C }, 1, { 0x005C }, 1,
        DEST_OP1, { 0x007C }, 1, true, -1
    },
    {
    ...
    },
    {
        ...
        OP_ADDD, 0x0004, 0x0004,
        { 0x005D }, 1, { 0x005C }, 1,
        DEST_OP1, { 0x000D }, 1, true, -1
    },
    {
        "SUBD  +5 - +5 = +0 (zero keeps op1 sign)",
        OP_SUBD, 0x0004, 0x0004,
        { 0x005C }, 1, { 0x005C }, 1,
        DEST_OP1, { 0x000C }, 1, true, -1
    },
    {
    ...
    },
    {
        ...
        OP_ADDD, 0x0013, 0x0013,
        { 0x0100, 0x0000, 0x0000, 0x0000, 0x001C }, 5,
        { 0x0000, 0x0000, 0x0000, 0x0000, 0x001C }, 5,
        DEST_OP1, { 0x0100, 0x0000, 0x0000, 0x0000, 0x002C }, 5, true, -1
    },
    {
    ...
    },
    {
        ...
        OP_COMD, 0x0004, 0x0004,
        { 0x005C }, 1, { 0x012C }, 1,
        DEST_NONE, { 0 }, 0, true, 0xFFFF
    },
    {
        "COMD  +12 = +12 -> A = 0",
        OP_COMD, 0x0004, 0x0004,
        { 0x012C }, 1, { 0x012C }, 1,
        DEST_NONE, { 0 }, 0, true, 0
    },
    {
        "COMD  -12 < +5  -> A = 0xFFFF",
        OP_COMD, 0x0004, 0x0004,
    ...
    /* ---------------------------------------------------------------- */
    {
        ...
        "SHDE  +123 >> 1 = +012",
        OP_SHDE, 0x0024, 0x0004,
        { 0x123C }, 1, { 0x0000 }, 1,
        DEST_OP2, { 0x012C }, 1, true, -1
    },
    {
        ...
        OP_SHDE, 0x0004, 0x0024,
        { 0x123C }, 1, { 0x0000 }, 1,
        DEST_OP2, { 0x230C }, 1, false, -1
    },
    {
    ...
    },
    {
        ...
        OP_SHDE, 0x0044, 0x0404,
        { 0x149C }, 1, { 0x0000 }, 1,
        DEST_OP2, { 0x001C }, 1, true, -1
    },
    {
        "SHDE  +155 >> 2 rounded = +002",
        OP_SHDE, 0x0044, 0x0404,
        { 0x155C }, 1, { 0x0000 }, 1,
        DEST_OP2, { 0x002C }, 1, true, -1
    },
    {
        /* op1's sign propagates to op2. */
        "SHDE  -123 (no shift) = 0x123D",
        OP_SHDE, 0x0004, 0x0004,
        { 0x123D }, 1, { 0x0000 }, 1,
        DEST_OP2, { 0x123D }, 1, true, -1
    },
    {
        /* op2 D2 bit 13 (0x2000) forces the unsigned 0xF sign nibble. */
        "SHDE  +123 -> unsigned dest = 0x123F",
        OP_SHDE, 0x0004, 0x2004,
        { 0x123C }, 1, { 0x0000 }, 1,
        DEST_OP2, { 0x123F }, 1, true, -1
    },
    {
    ...
    /* ---------------------------------------------------------------- */
    {
        ...
        OP_PACK, 0x0003, 0x0004,
        { 0x3132, 0x3500 }, 2,
        { 0x0000 }, 1,
        DEST_OP2, { 0x125C }, 1, true, -1
    },
    {
    ...
    /* ---------------------------------------------------------------- */
    {
        ...
        OP_UPACK, 0x0004, 0x0003,
        { 0x123D }, 1,
        { 0x0000, 0x0000 }, 2,
        DEST_OP2, { 0x3132, 0x4C00 }, 2, true, -1
    },
    {
    ...
    },
    {
        ...
        { 0x005C }, 1,
        { 0x0000, 0x0000 }, 2,
        DEST_OP2, { 0x3030, 0x4500 }, 2, true, -1
    },
    {
